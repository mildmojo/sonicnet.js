...
module.exports = {
  SonicSocket: window.SonicSocket,
  SonicServer: window.SonicServer,
  SonicCoder: window.SonicCoder
}
...
SonicServer.prototype.raf_ = function(callback) {
  var isCrx = (typeof chrome !== 'undefined') && (chrome.app.runtime || chrome.extension);
  if (isCrx) {
